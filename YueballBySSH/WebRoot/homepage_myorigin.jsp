...
<Body bgcolor=#66FFAA><center>
 ...
 <s:iterator value="#request['originmatch']" var="match">
				<tr>
					...
					<td>
						<form action="" method="post">
							...
							<input type="submit" id="joinMatchButton" value="是否删除"
  ...
  <BR>
  	<div>
			<s:set value="#request.originpager" var="pager"></s:set>
			<s:if test="#pager.hasFirst">
				<a href="getMatchPagingByMatchId.action?currentPage=1"> 首页</a>
			</s:if>
			<s:if test="#pager.hasPrevious">
				<a
					href="getMatchPagingByMatchId.action?currentPage=<s:property value="#pager.currentPage-1"/>">
					上一页 </a>
			</s:if>
			...
			<s:if test="#pager.hasLast">
				<a
					href="getMatchPagingByMatchId.action?currentPage=<s:property value="#pager.totalPage"/>">
					尾页 </a>
			</s:if>
			<br> 当前第
