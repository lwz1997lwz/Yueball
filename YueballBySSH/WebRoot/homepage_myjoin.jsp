...
<Body bgcolor=#66FFAA><center>
 ...
 <s:iterator value="#request['joinmatch']" var="match">
  ...
  <BR>
  	<div>
			<s:set value="#request.joinpager" var="pager"></s:set>
			<s:if test="#pager.hasFirst">
				<a href="getJoinMatchPaging.action?currentPage=1"> 首页</a>
			</s:if>
			<s:if test="#pager.hasPrevious">
				<a
					href="getJoinMatchPaging.action?currentPage=<s:property value="#pager.currentPage-1"/>">
					上一页 </a>
			</s:if>
			...
			<s:if test="#pager.hasLast">
				<a
					href="getJoinMatchPaging.action?currentPage=<s:property value="#pager.totalPage"/>">
					尾页 </a>
			</s:if>
			<br> 当前第
